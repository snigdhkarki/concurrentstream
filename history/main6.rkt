...
(define loss '())
(define (parallel-find-loss random-matrices)        
        (parallel-execute (lambda () (let ((loss1 (sum-modulus (subtractwithoutput (multiplywithinput (addwithinitial (list-ref random-matrix-list 0))))))) (set! loss (cons loss1 loss))))
                          (lambda () (let ((loss2 (sum-modulus (subtractwithoutput (multiplywithinput (addwithinitial (list-ref random-matrix-list 1))))))) (set! loss (cons loss2 loss))))
                          (lambda () (let ((loss3 (sum-modulus (subtractwithoutput (multiplywithinput (addwithinitial (list-ref random-matrix-list 2))))))) (set! loss (cons loss3 loss))))
                          (lambda () (let ((loss4 (sum-modulus (subtractwithoutput (multiplywithinput (addwithinitial (list-ref random-matrix-list 3))))))) (set! loss (cons loss4 loss))))))
...
(define (looper initial n)
        ...
        (parallel-find-loss random-matrix-list)        
