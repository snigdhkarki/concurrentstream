;;it is concurrent program so use https://www.jdoodle.com/execute-racket-online/
...
(parallel-execute (lambda ()
  (let ((fin1 (looper initial 100)))
    (set! my-list (cons fin1 my-list))
    )) (lambda ()
  (let ((fin2 (looper initial 100)))
    (set! my-list (cons fin2 my-list))
    )) (lambda ()
  (let ((fin3 (looper initial 100)))
    (set! my-list (cons fin3 my-list))
    )) (lambda ()
  (let ((fin4 (looper initial 100)))
